"""
Django settings for toprofile project.
...
MIDDLEWARE = [
    ...
    # "toprofile.middleware.DeviceTrackerMiddleware",
    # "toprofile.middleware.MostViewPageMiddleware"
]

ROOT_URLCONF = 'toprofile.urls'
...
WSGI_APPLICATION = 'toprofile.wsgi.application'
...
# Brevo SMTP defaults; all values can be overridden from .env.
...
# Support either Django-standard keys or Brevo-specific aliases.
EMAIL_HOST_USER = config(
    "EMAIL_HOST_USER",
    default=config("BREVO_SMTP_LOGIN", default=""),
)
EMAIL_HOST_PASSWORD = config(
    "EMAIL_HOST_PASSWORD",
    default=config("BREVO_SMTP_KEY", default=""),
)

DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL",
    default=(EMAIL_HOST_USER or "no-reply@toprofile.com"),
)
SERVER_EMAIL = config("SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
EMAIL_SUBJECT_PREFIX = config("EMAIL_SUBJECT_PREFIX", default="[Toprofile] ")
...
#     "http://localhost:8080",
#     "http://127.0.0.1:8000",
#     "https://e396-197-211-58-212.ngrok-free.app"
# ]
CORS_ALLOW_METHODS = (
    "DELETE",
    "GET",
